...
curl -l "https://raw.githubusercontent.com/piplup55/misc/yuzu/mesa/mesa/22.1.1/radeon_icd.x86_64.json" -o "$HOME/emudeck/mesa/22.2.1/radeon_icd.x86_64.json"
...
curl -l "https://raw.githubusercontent.com/piplup55/misc/yuzu/mesa/yuzu.sh" -o "$toolsPath\launchers\yuzu.sh" && chmod +x "$toolsPath\launchers\yuzu.sh"